/**
 * 
 * SemanticScrollTo - jQuery plugin for scrollTo without broke the anchors functionality
 *
 * Licensed under the MIT license
 *
 * Project home:
 *   https://github.com/viniciusalmeida/jQuery.semanticScrollTo
 *
 */
  ...
  $.fn.semanticScrollTo.methods = {
    ...
    __move: function (event) {
      ...
      var dispatcher             = $(event.target),
          anchorTarget           = this.__dispatcherTargetOrBody(dispatcher),
    ...
    __dispatcherTargetOrBody: function (dispatcher) {
